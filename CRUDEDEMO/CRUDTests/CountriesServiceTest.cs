...
namespace CRUDTests
{
    public class CountriesServiceTest
    {
        ...
        //When CountryAddResquest is null, it should throw ArguementNullException
        [Fact]
        ...
        public async Task GetAllCountries_AddFewCountries()
        {
            ...
            List<CountryAddRequest> country_request_list = new List<CountryAddRequest>()
            {
                ...
                new CountryAddRequest() {CountryName = "Nigeria"}
            };
        ...
        [Fact]
        //If we supply a valid countryid, it should return the matching details as CountryResponse object
