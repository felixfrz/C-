...
namespace ServiceContracts.DTO
{
    ...
    public class PersonResponse
    {
        ...
        /// <returns>True or false, indicating wether all person details are matched with the specified parameter object</returns>
    ...
    public static class PersonExtensions
    {
        ...
        public static PersonResponse ToPersonResponse(this Person person)
        {
            ...
            return new PersonResponse() {  PersonID = person.PersonID, PersonName = person.PersonName, Email = person.Email, DateOfBirth = person.DateOfBirth, Gender = person.Gender, Address = person.Address, CountryID = person.CountryID, ReceiveNewsLetters = person.ReceiveNewsLetters, Age = (person.DateOfBirth != null) ? Math.Round((DateTime.Now - person.DateOfBirth.Value).TotalDays / 365.25) : null, Country = person.Country?.CountryName };
        }
    }
}
